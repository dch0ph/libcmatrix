#ifndef _unary_composition_h_
#define _unary_composition_h_

namespace libcmatrix {

  template<class Op1,class Op2> class unary_composition : public ::std::unary_function<typename Op2::argument_type,typename Op1::result_type>
  {
    Op1 op1_;
    Op2 op2_;
  public:
  ...
  public ::std::iterator< 
    typename ::std::iterator_traits<Iter>::iterator_category,typename Op::result_type, typename ::std::iterator_traits<Iter>::difference_type,
...
template<class T> class cyclic_iterator : public ::std::iterator< 
  typename LCM_iterator_cat_< ::std::iterator_traits<typename T::iterator> >::iterator_category,
  LCM_VAL(T) > {
 public:
...
template<class T> class cyclic_const_iterator : public ::std::iterator< 
  typename LCM_iterator_cat_< ::std::iterator_traits<typename T::const_iterator> >::iterator_category,
...
template<typename T> struct doesnothing : public ::std::unary_function<T,T> {
